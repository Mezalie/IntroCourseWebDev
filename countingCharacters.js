function countingCharacters(stringToCount){
    // The length property has benn mentioned in 
...
function countingCharacters3(str, search){
    ...
    var numChars = search.length; /* we need to stoop loop based on multiple characters example: if searching "Ohio" with 3 characters at a time we want to stop at h so we do not go past the end of the string */
